...
The following notion of extension pair is crucial for
...
An extension pair  $(q_{1}', q_{2}')$ is \emph{terminal} if and only if $q_{1}'$ is
the \$-backward extension on $B'$ of an interval on $B'$.
\notaestesa{Paola}{rivedere anche in termini informali}


Our main contribution is an external memory algorithm to compute the
extension pairs.
