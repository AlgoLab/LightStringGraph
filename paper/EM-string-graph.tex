...
\institute{DISCo,
   Univ. Milano-Bicocca,
   Milan, Italy\\ \email{\{bonizzoni,dellavedova,pirola,previtali,rizzi\}@disco.unimib.it}
...
% , as they are computed in $Q_{j+1}$ in
% an arbitrary order.
...
Inoltre rinominerei extendLinkedInterval in extendLinkedIntervals
\end{comment}
